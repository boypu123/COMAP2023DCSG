    ...
    <div class="info">
        <div class="infoContent">
            ...
            <p>
                ...
                For students below <b>14.5 years old</b> at the start of the contest.
            </p>
            <br>
            ...
            <p>
                ...
                There are no specific prerequisites, but you are expected to know some content in IGCSE extended/additional mathematics and in IB AA maths as well.<br>
                ...
                -	Data Fitting<br>
                -	Machine Learning (Basic, using scikit-learn)<br>
                -	Grey Prediction Model (GM (1,1) is preferred)<br>

                Linear Algebra<br>
                -	Matrix Addition<br>
                -	Matrix Multiplication<br>

                Basic Computational Thinking Skills + Algorithm:<br>
                -	Decomposition of Problems<br>
                -	Greedy Algorithm<br>

                Writing Mathematical Essay:<br>
                -	Section Organisation<br>
                -	Writing an Abstract<br>
                -	Experiences<br>

                Again, this only provides an overview and is not necessarily the case depending on the questions. Anyway, these are very easy things to learn as well. You can probably learn it within 3 days if you take 2 hours per day.
            </p> <br>
            ...
            <p>
                ...
                If you want a paper version of the registration form, please contact hongwen.pu25@stu.dulwich.org.
                <br><b>Please follow @COMAPMath on Twitter(X) or @COMAPCHINAOFFICIAL on Weibo for the latest updates from the official!</b>
                <p style="text-align: center; font-weight: bold;">Thank you very much! 谢谢！ありがとうございました！</p>
            </p>
